...
public class CreationTests {
    ...
    public void testStandardCreation() throws IOException {
        ...
        assert RuneweaverCodecs.JSON_ELEMENT.deserialize(resource).equals(goalObject) : "Resource was not created correctly";
    }
    ...
    public void testListCreation() throws IOException {
        ...
        JsonElement element = RuneweaverCodecs.JSON_ELEMENT.deserialize(resourceListA.get(0));
        ...
        element = RuneweaverCodecs.JSON_ELEMENT.deserialize(resourceListB.get(randomOrdinal));
    ...
    public void testNamespaceCreation() throws IOException {
        ...
        JsonElement element = RuneweaverCodecs.JSON_ELEMENT.deserialize(resourceList.get(goalOrdinal));
